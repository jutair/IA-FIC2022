...
nome = 'jutair_da_silva_rios' # # coloque aqui o nome completo sem espaços (colocar '_' entre as palavras e.g. gustavo_voltani_von_atzingen) no formato de uma string
email = 'contatojutair@gmail.com' # Coloque o seu email aqui no formato string como no exemplo
